...
class PharmacyHomeMostPopularItems extends StatelessWidget {
  const PharmacyHomeMostPopularItems({super.key});
                ...
                return CustomPopularItems(
                  onTap: () {
                    AppRoutes.goCartView(
                      image:
                          'https://www.quantretail.com/loadImage?imageOid=957042',
                      item: CartProductsModel(
                        itemName: "Dr.Max Slovakia | Case Study | Quant",
                        shopName: "Intelligent Retail Platform",
                        price: 300,
                        quantity: 1,
                      ),
                    );
                  ...
                  imageUrl:
                      'https://www.quantretail.com/loadImage?imageOid=957042',
                  title: 'Dr.Max Slovakia | Case Study | Quant',
                  itemSize: 'EACH',
                  price: 300,
                  rating: 1,
